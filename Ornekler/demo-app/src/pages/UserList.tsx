        ...
        <div className="row mb-3 justify-content-center">
              {
                userList.map((user,index)=>{
                    return(
                        <div key={index} className={user.isActive ? "col-3 border m-2 rounded-3 shadow text-bg-success" : "col-3 border m-2 rounded-3 shadow text-bg-secondary"}>
                        <div className='mb-3'>
                        ...
                        <div className="mb-3 form-check form-switch">
                            ...
                            }} type="checkbox" className="form-check-input" role='switch' defaultChecked={user.isActive} />
                        </div>
                    </div>
                    )
                })
